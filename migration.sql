...
ALTER TABLE `artists_events` ADD CONSTRAINT `artists_events_fk0` FOREIGN KEY (`artist_id`) REFERENCES `artists`(`id`);

ALTER TABLE `artists_events` ADD CONSTRAINT `artists_events_fk1` FOREIGN KEY (`events_id`) REFERENCES `events`(`id`);
